...
public class ColorRoundProgressBar extends View {
    /**
     * 画笔对象的引用
    ...
    public ColorRoundProgressBar(Context context) {
        this(context, null);
    }

    public ColorRoundProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorRoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
